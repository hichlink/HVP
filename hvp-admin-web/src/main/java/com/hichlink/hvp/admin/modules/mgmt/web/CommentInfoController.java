...
import com.hichlink.hvp.common.service.CommentInfoService;


/**
 * 
 * <b>Title：</b>CommentInfoController.java<br/>
 * <b>Description：</b> <br/>
...
public class CommentInfoController extends BaseController{
	private static final Logger LOG = LoggerFactory.getLogger(CommentInfoController.class);
    @Autowired
    @Qualifier("commentInfoService")
    private CommentInfoService commentInfoService;
    
    @RequestMapping(value = "/query.ajax")
	@ResponseBody
	 public Map<String, Object> pageQuery(Page<CommentInfo> page) {
	    Page<CommentInfo> list = commentInfoService.pageQuery(page);
	    return super.page(list);
    }
         @RequestMapping(value = "/add.ajax", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> add(@ModelAttribute("commentInfo") CommentInfo data) {
    	commentInfoService.saveAndUpdate(data);
	...
	@ResponseBody
	 public Map<String, Object> delete(Long commentId) {
    		commentInfoService.delete(commentId);
			return super.success("删除成功");
	  }
	 @RequestMapping(value = "/get.ajax")
	 @ResponseBody
	 public Map<String, Object> get(Long commentId) {
		 	CommentInfo data = commentInfoService.get(commentId);
	    ...
	    */
		...
		public void getForUpdate(@RequestParam(value = "updId",required=false) Long updId,
				Model model) {
								if (null != updId) {
									   model.addAttribute("commentInfo",commentInfoService.get(updId));
				  }else{
