...
import com.hichlink.hvp.common.service.PlayerInfoService;


/**
 * 
 * <b>Title：</b>PlayerInfoController.java<br/>
 * <b>Description：</b> <br/>
...
public class PlayerInfoController extends BaseController{
	private static final Logger LOG = LoggerFactory.getLogger(PlayerInfoController.class);
    @Autowired
    @Qualifier("playerInfoService")
    private PlayerInfoService playerInfoService;
    
    @RequestMapping(value = "/query.ajax")
	@ResponseBody
	 public Map<String, Object> pageQuery(Page<PlayerInfo> page) {
	    Page<PlayerInfo> list = playerInfoService.pageQuery(page);
	    return super.page(list);
    }
         @RequestMapping(value = "/add.ajax", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> add(@ModelAttribute("playerInfo") PlayerInfo data) {
    	playerInfoService.saveAndUpdate(data);
		return super.success("新增成功");
    }
   
    @RequestMapping(value = "/delete.ajax")
	@ResponseBody
	 public Map<String, Object> delete(Long playerId) {
    		playerInfoService.delete(playerId);
			return super.success("删除成功");
	  }
	 @RequestMapping(value = "/get.ajax")
	 @ResponseBody
	 public Map<String, Object> get(Long playerId) {
		 	PlayerInfo data = playerInfoService.get(playerId);
	    ...
	    */
		...
		public void getForUpdate(@RequestParam(value = "updId",required=false) Long updId,
				Model model) {
								if (null != updId) {
									   model.addAttribute("playerInfo",playerInfoService.get(updId));
				  }else{
