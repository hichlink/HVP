...
import com.hichlink.hvp.common.service.ViewRecordService;


/**
 * 
 * <b>Title：</b>ViewRecordController.java<br/>
 * <b>Description：</b> <br/>
...
public class ViewRecordController extends BaseController{
	private static final Logger LOG = LoggerFactory.getLogger(ViewRecordController.class);
    @Autowired
    @Qualifier("viewRecordService")
    private ViewRecordService viewRecordService;
    
    @RequestMapping(value = "/query.ajax")
	@ResponseBody
	 public Map<String, Object> pageQuery(Page<ViewRecord> page) {
	    Page<ViewRecord> list = viewRecordService.pageQuery(page);
	    return super.page(list);
    }
         @RequestMapping(value = "/add.ajax", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> add(@ModelAttribute("viewRecord") ViewRecord data) {
    	viewRecordService.saveAndUpdate(data);
